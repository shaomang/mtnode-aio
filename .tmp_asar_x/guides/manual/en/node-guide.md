...
- Newer kinds have guides too: **music / video generation, network receive / send, execute, global, file / table / database replica**, see [Music, video, network and execute nodes](#media-net) and [Database nodes](#database-nodes).
