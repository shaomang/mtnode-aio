...
## 端子
- **输入**：端口 0 = 控制输入（固定）· 端口 1 = 提示词 · **R2V** 模式：端口 2–10 = 参考图 I1–I9、端口 11–13 = 参考视频 V1–V3、端口 14–16 = 参考音频 A1–A3（三组端子一次排全，端子号与后端 `ref_image_0..8` / `ref_video_0..2` / `ref_audio_0..2` 一一对应）· **FL2VA** 模式：端口 2–3 = 首帧 F / 末帧 L
