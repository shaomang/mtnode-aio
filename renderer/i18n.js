...
(function (root, factory) {
  ...
  Object.assign(EN, {
    ...
    "将自动差分下载更新包（仅变更部分），下载完成后自动安装并重启。当前版本：v":
      "Will differentially download only changed blocks, then install and restart. Current: v",
    "正在下载更新…": "Downloading update…",
    "开始下载更新（差分包）…": "Downloading update (differential)…",
    "更新已下载，即将安装并重启…": "Update downloaded — installing and restarting…",
    "更新失败：": "Update failed: ",
    ...
    "仅操作当前画布，不会切换画布或移动视角；改节点图或删除本画布会弹窗确认":
      "Current canvas only; will not switch canvases or move the view; graph edits or deleting this canvas ask for confirm",
    "可查看全部画布列表，但不会切换画布或移动你的视角；改节点图或删除工作流会弹窗确认":
      "Can list all canvases, but will not switch canvases or move your view; graph edits or deleting a workflow ask for confirm",
    "智能助手不能切换画布或改变你的视角（平移 / 缩放 / 居中 / 切视图）。请自行切换工作流，或使用顶栏「居中」。":
      "The assistant cannot switch canvases or change your view (pan / zoom / fit / change pane). Switch workflows yourself, or use the toolbar Fit button.",
    ...
    "智能任务仅能访问当前画布，无法读取、切换或新建其他画布。":
      "Agent tasks can only access the current canvas; reading, switching, or creating other canvases is blocked.",
    ...
    "当前工作范围是本画布。我能查看并修改当前工作流节点与配置，但不会切换画布或移动视角。\n可以说「总结画布」或「搭一个 xxx 工作流」。\n改节点图前会请你确认；要参考其他画布请把工作范围改为「全局」。":
      "Scope is this canvas. I can view/edit the current workflow, but will not switch canvases or move the view.\nTry \"summarize the canvas\" or \"build a xxx workflow\".\nGraph edits ask for confirm; switch work scope to Global to reference other canvases.",
    "我能看到当前工作流、节点与配置，也可参考其他画布列表，但不会切换画布或平移/缩放你的视角。\n可以说「总结画布」或「搭一个 xxx 工作流」。\n改节点图或删除工作流前会请你确认。":
      "I can see the workflow, nodes, and settings, and can list other canvases, but will not switch canvases or pan/zoom your view.\nTry \"summarize the canvas\" or \"build a xxx workflow\".\nGraph edits or deleting a workflow will ask for confirmation.",
